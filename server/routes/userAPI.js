...
module.exports = (router) => {
  ...
  router.post('/saveUserChanges', (req, res) => {
    ...
    User.findOneAndUpdate({ "_id": ObjectID(req.decoded.userId) }, { $set: { bestgirl: req.body.bestgirl, avatar: req.body.avatar, autoTimelineAdd: req.body.autoTimelineAdd } }, (err, user) => {
      if (err) {
        res.json({ success: false, message: err });
      } else {
